...
```{r fig 3, fig.width=8,fig.height=5, fig.cap='Comparing regression models for confirmed and died COVID-19 cases for 15th Oct, 2020', echo = FALSE , results = "asis", warning = FALSE, message = FALSE }
